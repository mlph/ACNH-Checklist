...
const headersDefault = {
  items: [
    ...
    { name: '搭載性', key: 'surface', enable: false, toggleSwitch: false },
    { name: '使用可能', key: 'interact', enable: false, toggleSwitch: false },
    { name: 'タグ', key: 'tag', enable: false, toggleSwitch: false },
    { name: '追加されたバージョン', key: 'version', enable: false, toggleSwitch: false },
  ...
  creatures: [
    ...
    { name: '難易度', key: 'catchDifficulty', enable: false, toggleSwitch: false },
    { name: 'スピード', key: 'movementSpeed', enable: false, toggleSwitch: false },
    { name: '影', key: 'shadow', enable: false, toggleSwitch: false },
    { name: '出現率', key: 'spawnRates', enable: false, toggleSwitch: false },
    { name: '視界', key: 'vision', enable: false, toggleSwitch: false },
    { name: '天気', key: 'weather', enable: false, toggleSwitch: false },
    { name: '場所', key: 'whereHow', enable: false, toggleSwitch: false },
    { name: '元データ', key: 'rawdata', enable: false, toggleSwitch: false },
  ],
};
